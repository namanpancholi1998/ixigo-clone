...
export default function Navbar() {
  return (
    <nav className="nav-links relative flex h-full items-center font-semibold text-slate-500 mx-5 max-lg:gap-0 max-lg:fixed max-lg:bottom-0 max-lg:h-16 max-lg:w-full max-lg:left-0 max-lg:mx-0 max-lg:px-4  max-lg:justify-between max-lg:shadow z-10">
